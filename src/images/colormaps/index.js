...
import dense from "./dense.png";
import diff from "./diff.png";
import grayscale_reverse from "./grayscale_reverse.png";
import grayscale from "./grayscale.png";
import haline from "./haline.png";
...
const colormaps = {
  ...
  Dense: { name: "dense", path: dense },
  Diff: { name: "diff", path: diff },
  Grayscale_reverse: { name: "grayscale_reverse", path: grayscale_reverse },
  Grayscale: { name: "grayscale", path: grayscale },
  Haline: { name: "haline", path: haline },
  Ice: { name: "ice", path: ice },
  Matter: { name: "matter", path: matter },
  Natural: { name: "natural", path: natural },
  Oxy: { name: "oxy", path: oxy },
  Phase: { name: "phase", path: phase },
  Rain: { name: "rain", path: rain },
